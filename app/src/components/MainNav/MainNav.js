            ...
            <div className="side-menu" id="main-menu">
                <div className="menu">
                    <ul className="dropdown">
                        ...
                        <li data-toggle="tooltip" data-placement="right" title="twitch"><div onClick={() => main.twitchWindow()} className="btn nav-link setting-open-btn twitch-btn"><i className="fab fa-twitch menu-icon"></i></div></li>
