        ...
        return(
            <div className="card-settings">
                <div className="card-header">
                    <h5 className="mb-0">
                        <button className="btn btn-link" type="button" data-toggle="collapse" data-target="#appearance" aria-expanded="true" aria-controls="appearance">{this.props.langPack.title}</button>
                    </h5>
                </div>
                <div id="appearance" className="collapse">
