    ...
    render() {
        return(
            ...
            <div className="container-block">
                <Img 
                    src={this.props.profileBanner} 
                    className="img-fluid profile-banner" 
                    alt="" 
                    loader={<ContentLoader className="img-fluid profile-banner"   primaryColor="#6441A4" secondaryColor="#7a5fb9"><rect x="1.18" y="-14.99" rx="5" ry="5" width="100%" height="100%" /></ContentLoader>}
                />
            </div>
            <div className="container-block channel-top-header">
                <ul className="channel-top-nav">
                    ...
                    <li className="nav-option">{this.props.langPack.followers} <span>{this.state.followers}</span></li>
                    <li className="nav-option">{this.props.langPack.views} <span>{this.state.views}</span></li>
                    <li onClick={() => this.props.navLayout("#videos")} className="nav-option">{this.props.langPackCategories.videos}</li>
                    <li onClick={() => this.props.navLayout("#clips")} className="nav-option">{this.props.langPackCategories.clips}</li>
                </ul>
