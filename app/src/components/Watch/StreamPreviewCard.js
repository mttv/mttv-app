            ...
            <div className="card stream-preview">
                <div className="card-image-container">
                    ...
                    <div className="card-img-overlay">
                        <h5 className="card-title">{(props.type === "live") ? props.langPackOthers.content_types.live : props.langPackOthers.content_types.rerun}</h5>
                        <p className="card-text">{props.viewers} {props.langPackOthers.viewers}</p>
