        ...
        return(
            <div id="search">
                <div className="container">
                    ...
                    <input type="text" id="search-input" className="form-control form-control-lg border-0 shadow-sm" autoFocus={true} placeholder={this.props.langPack.title + "..."} onChange={this.searchHandler} />
